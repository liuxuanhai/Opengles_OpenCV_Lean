...
public class DisGLImg {
    ...
    public DisGLImg(Context context) {
        //---->[构造函数中加载贴图获取句柄]----
        textureId1 = GLTexture.loadTexture(context, R.mipmap.girl);
        textureId2 = GLTexture.loadTexture(context, R.mipmap.self);


        program = LoadProgram.initProgramByAssets(context, "texture.vsh.glsl", "img_he.fsh.glsl");
        ...
        //寻找句柄
        uMixture = GLES30.glGetUniformLocation(program, "uMixture");
    }
    ...
    public void draw(float[] mvpMatrix) {
        ...
        GLES30.glUniform1f(uMixture, mixture); //赋值
