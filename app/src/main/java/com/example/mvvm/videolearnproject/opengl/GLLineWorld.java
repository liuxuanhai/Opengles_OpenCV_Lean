 ...
 * desc   : 描述
 */
public class GLLineWorld extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    GLTieTuView glTieTuView;
    public GLLineWorld(Context context) {

        this(context, null);
        this.context=context;
    }
    public GLLineWorld(Context context, AttributeSet attrs) {
        super(context, attrs);
