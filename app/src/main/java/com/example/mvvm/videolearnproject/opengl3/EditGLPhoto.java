...
public class EditGLPhoto {
    ...
    public EditGLPhoto(Context context) {
//        textureId= GLTexture.loadTexture(context, R.mipmap.jiejing);
        textureId= GLTexture.loadTexture(context, R.mipmap.self);

//        program = LoadProgram.initProgramByAssets(context, "tietu.vsh.glsl", "photot_gray.fsh.glsl");
        program = LoadProgram.initProgramByAssets(context, "tietu.vsh.glsl", "black_white.fsh.glsl");
