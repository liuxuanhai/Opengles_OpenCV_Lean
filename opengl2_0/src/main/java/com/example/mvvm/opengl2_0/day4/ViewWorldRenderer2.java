...
import com.example.mvvm.opengl2_0.comm.MatrixStack;
 ...
 * desc   : 描述
 */
public class ViewWorldRenderer2 implements GLSurfaceView.Renderer {
    ...
    public ViewWorldRenderer2(Context context, int num) {
        mContext = context;
        this.num = num;
    }
