 ...
 * desc   : 描述
 */
public class AssetsTriangleRender implements GLSurfaceView.Renderer {
    AssetsTriangle triangle;
    ...
    public AssetsTriangleRender(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        triangle=new AssetsTriangle(context);
    }
    @Override
...
//        triangle.draw();
        ...
        //设置沿Z轴位移
//        Matrix.translateM(mOpMatrix, 0, 0, 0, currDeg);
