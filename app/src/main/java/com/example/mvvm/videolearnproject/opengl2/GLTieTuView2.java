...
public class GLTieTuView2 {
    ...
    public GLTieTuView2(Context context) {
        //---->[构造函数中加载贴图获取句柄]----
        textureId1 = GLTexture.loadTexture(context, R.mipmap.jiejing);
        textureId2 = GLTexture.loadTexture(context, R.mipmap.tietu);


        program = LoadProgram.initProgramByAssets(context, "texture.vsh.glsl", "texture2.fsh.glsl");
