...
public class DisDiffGL {
    ...
    public DisDiffGL(Context context) {
        textureId = GLTexture.loadTexture(context, R.mipmap.girl);

//        program = LoadProgram.initProgramByAssets(context, "tietu.vsh.glsl", "fupian.fsh.glsl");
        //怀旧
//        program = LoadProgram.initProgramByAssets(context, "tietu.vsh.glsl", "huaijiu.fsh.glsl");
        //冷调
//        program = LoadProgram.initProgramByAssets(context, "tietu.vsh.glsl", "lengdiao.fsh.glsl");
//       流年
//        program = LoadProgram.initProgramByAssets(context, "tietu.vsh.glsl", "liunian.fsh.glsl");

        //图片，x轴反转
//        program = LoadProgram.initProgramByAssets(context, "tietu.vsh.glsl", "x_fan.fsh.glsl");

        //图片，x轴反转
//        program = LoadProgram.initProgramByAssets(context, "tietu.vsh.glsl", "y_fan.fsh.glsl");

        //图片，xy轴反转
        program = LoadProgram.initProgramByAssets(context, "tietu.vsh.glsl", "xy_fan.fsh.glsl");
