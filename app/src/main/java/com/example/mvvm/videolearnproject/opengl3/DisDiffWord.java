 ...
 * desc   : 描述
 */
public class DisDiffWord extends GLSurfaceView implements GLSurfaceView.Renderer {
    private static final String TAG = "GLWorld";

    private DisDiffGL disDiffGL;
    ...
    public DisDiffWord(Context context) {

        this(context, null);
        this.context=context;
    }
    public DisDiffWord(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        disDiffGL=new DisDiffGL(context);
    }
