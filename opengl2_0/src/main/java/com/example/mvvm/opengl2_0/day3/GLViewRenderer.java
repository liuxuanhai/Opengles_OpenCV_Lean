...
import com.example.mvvm.opengl2_0.day2.TextureRectangle;
import com.example.mvvm.opengl2_0.day2.TextureRectangle2;
...
public class GLViewRenderer implements GLSurfaceView.Renderer {
    ...
    public GLViewRenderer(Context context, int num) {
