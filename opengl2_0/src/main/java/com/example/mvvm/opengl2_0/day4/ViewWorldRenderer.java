...
import com.example.mvvm.opengl2_0.day3.WorldShape;
import com.example.mvvm.opengl2_0.day3.WorldShape2;
import com.example.mvvm.opengl2_0.day3.WorldShape3;
import com.example.mvvm.opengl2_0.day3.WorldShape4;
 ...
 * desc   : 描述
 */
public class ViewWorldRenderer implements GLSurfaceView.Renderer {
    ...
    public ViewWorldRenderer(Context context, int num) {
        mContext = context;
        this.num=num;
    }
